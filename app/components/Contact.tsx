    ...
    <section id="contact" className="border-t border-rule bg-surface" aria-labelledby="contact-heading">
      <div className="max-w-[1160px] mx-auto px-[24px] md:px-[5vw] lg:px-[7vw] py-[80px] lg:py-[120px] flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[40px] md:gap-[64px] w-full max-w-[800px]">
          {/* Anna Ison */}
          <div className="flex flex-col items-center p-[40px] bg-ink border border-rule transition-all duration-350 ease-out hover:border-teal hover:-translate-y-[4px] group/card1" data-animate="fade" data-delay="3">
            <div className="w-[140px] h-[140px] rounded-full overflow-hidden mb-[24px] border-2 border-rule transition-colors duration-350 group-hover/card1:border-teal">
            ...
            <div className="flex flex-col gap-[12px] text-[13px] text-muted font-mono w-full">
              <a href="tel:+919072412897" className="hover:text-teal transition-colors">📞 +91 9072412897</a>
              <a href="mailto:remap@excelmec.org" className="hover:text-teal transition-colors">✉️ remap@excelmec.org</a>
              <a href="#" className="hover:text-teal transition-colors underline underline-offset-4 decoration-rule hover:decoration-teal">LinkedIn</a>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center p-[40px] bg-ink border border-rule transition-all duration-350 ease-out hover:border-accent hover:-translate-y-[4px] group/card2" data-animate="fade" data-delay="4">
            ...
            <div className="flex flex-col gap-[12px] text-[13px] text-muted font-mono w-full">
              <a href="tel:+919142157542" className="hover:text-accent transition-colors">📞 +91 9142157542</a>
              <a href="mailto:remap@excelmec.org" className="hover:text-accent transition-colors">✉️ remap@excelmec.org</a>
