...
export default function Hero() {
  ...
  return (
    <section 
      id="top"
      className="relative w-full min-h-[100dvh] flex flex-col justify-center overflow-hidden isolate group" 
      aria-label="Hero"
    >
      {/* Background */}
      <div 
      ...
      <div className="relative z-2 max-w-[680px] px-[24px] md:px-[5vw] lg:px-[7vw] py-[120px] md:py-[160px]" style={contentStyle}>
